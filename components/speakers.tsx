...
import { keynoteSpeaker, speakers } from "@/data"
    ...
    <section id="speakers" className="py-12 md:py-20 lg:py-32 bg-gradient-to-br from-slate-900 via-blue-900/90 to-slate-900 relative overflow-hidden">
      <div className="absolute inset-0 constellation-background">
        <div className="constellation-container">
          <div className="constellation-svg" style={{ top: "20%", left: "10%", width: "180px", height: "auto", opacity: "0.06" }}>
            <img src="/art-assets/ray.svg" alt="" className="w-full h-auto animate-gentle-pulse" style={{ transform: "rotate(45deg)" }} />
          </div>
          <div className="constellation-svg" style={{ bottom: "25%", right: "12%", width: "160px", height: "auto", opacity: "0.08" }}>
            <img src="/art-assets/ray.svg" alt="" className="w-full h-auto animate-gentle-pulse" style={{ transform: "rotate(-30deg)" }} />
          </div>
          <div className="constellation-svg" style={{ top: "15%", right: "20%", width: "200px", height: "auto", opacity: "0.05" }}>
            <img src="/art-assets/shroud.svg" alt="" className="w-full h-auto animate-float-slow" />
          </div>
          <div className="constellation-svg constellation-hover-spin" style={{ top: "35%", left: "8%", width: "70px", height: "auto" }}>
            <img src="/art-assets/leo.svg" alt="" className="w-full h-auto constellation-glow-orange animate-gentle-shimmer" style={{ opacity: "0.4" }} />
          </div>
          <div className="constellation-svg constellation-hover-spin" style={{ bottom: "30%", right: "6%", width: "65px", height: "auto" }}>
            <img src="/art-assets/orion.svg" alt="" className="w-full h-auto constellation-glow-orange animate-gentle-shimmer-delayed" style={{ opacity: "0.45" }} />
          </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-8 sm:mb-12 md:mb-16 lg:mb-20">
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed px-3 sm:px-4 md:px-0">
            Get insights from leading professionals who are shaping the future of cloud technology and driving innovation in the AWS ecosystem.
          </p>
        </div>
            ...
            <div className="relative text-center group perspective-1000">
              <div className="relative mx-auto mb-6 sm:mb-8 md:mb-12 w-48 h-48 sm:w-56 sm:h-56 md:w-72 md:h-72 lg:w-80 lg:h-80">
                ...
                <div className="relative w-full h-full rounded-full overflow-hidden border-4 border-gradient-to-r from-yellow-400 to-orange-500 shadow-2xl group-hover:shadow-yellow-500/50 transition-all duration-1000 transform group-hover:scale-105 next-image-fill-container">
                  <OptimizedImage src={keynoteSpeaker.image} alt={keynoteSpeaker.name} fill className="object-cover transition-transform duration-1000 group-hover:scale-110" sizes="(max-width: 640px) 224px, (max-width: 768px) 288px, 320px" priority loading="eager" quality={95} />
                ...
                <div className="relative mb-3 sm:mb-4">
                  <div className="bg-gradient-to-br from-yellow-400 via-yellow-500 to-amber-600 p-0.5 rounded-lg shadow-2xl">
                    <div className="bg-gradient-to-br from-yellow-500 via-amber-500 to-yellow-600 rounded-lg px-4 sm:px-6 py-2 sm:py-3 relative overflow-hidden">
                      ...
                      <div className="absolute top-1 left-1 right-1 h-0.5 bg-gradient-to-r from-white/40 via-white/60 to-white/40 rounded-full"></div>
                      <div className="relative flex items-center justify-center text-amber-900">
                        ...
                        <span className="font-black text-sm sm:text-base md:text-lg tracking-wide drop-shadow-sm">KEYNOTE SPEAKER</span>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 sm:gap-4 md:gap-6 lg:gap-8 max-w-6xl mx-auto">
          {speakers.map((speaker, index) => (
            <div key={index} className={`group transition-all duration-1000 ${isVisible ? "animate-slide-up" : "opacity-0 translate-y-10"}`} style={{ animationDelay: `${index * 150}ms` }}>
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-xl sm:rounded-2xl p-2 sm:p-3 md:p-4 border border-white/10 shadow-xl group-hover:shadow-2xl group-hover:shadow-blue-500/20 transition-all duration-700 h-full flex flex-col group-hover:border-orange-500/30 min-h-[180px] sm:min-h-[200px] md:min-h-[240px]">
                  <div className="relative mx-auto mb-2 sm:mb-3 md:mb-4 w-20 h-20 sm:w-24 sm:h-24 md:w-32 md:h-32 lg:w-36 lg:h-36">
                    ...
                    <div className="relative w-full h-full rounded-full overflow-hidden border-2 border-gradient-to-r from-blue-500 to-purple-500 shadow-lg group-hover:shadow-blue-500/40 transition-all duration-700 group-hover:scale-105 next-image-fill-container">
                      <OptimizedImage src={speaker.image} alt={speaker.name} fill className={`object-cover transition-transform duration-700 group-hover:scale-110 ${speaker.name === "Ace Kenneth Batacandulo" ? "object-top" : ""}`} sizes="(max-width: 640px) 96px, (max-width: 768px) 128px, 144px" loading={index < 4 ? "eager" : "lazy"} priority={index < 2} quality={index < 4 ? 90 : 80} />
                    </div>
                  </div>
